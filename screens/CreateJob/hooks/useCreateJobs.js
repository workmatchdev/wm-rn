...
const useCreateJobs = (props) => {
    ...
    useEffect(() => {
        const getJob = async () => {
            const response = await axios.get(`https://workmatch-server-0c86658d19cb.herokuapp.com/api/jobs/getJob/${jobId}`);
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            const response = await axios.post('https://workmatch-server-0c86658d19cb.herokuapp.com/api/jobs/create', body);
            const data = response.data;
            alert(data.msg);
    ...
    const handleSubmitUpdate = async (values) => {
        try {
            ...
            const response = await axios.put(`https://workmatch-server-0c86658d19cb.herokuapp.com/api/jobs/update/${jobId}`, body);
    ...
    const handleDeleteItem = async (id) => {
        try {
            await axios.delete(`https://workmatch-server-0c86658d19cb.herokuapp.com/api/jobs/delete/${id}`);
            deleteJob(id);
